...
Json::const_reference access_json_value(
        const eprosima::xtypes::DynamicData::ReadableNode& xtypes_node,
...
bool json_to_xtypes(
        ...
        eprosima::xtypes::DynamicData& xtypes_message)
{
    std::stack<Json::const_pointer> json_stack;
    json_stack.push(&json_message);

    return xtypes_message.for_each([&](eprosima::xtypes::DynamicData::WritableNode& xtypes_node)
                   {
                       ...
                       {
                           case eprosima::xtypes::TypeKind::STRUCTURE_TYPE:
                           ...
                           case eprosima::xtypes::TypeKind::SEQUENCE_TYPE:
                               ...
                               break;
                           case eprosima::xtypes::TypeKind::ARRAY_TYPE:
                               json_stack.push(&access_json_value(xtypes_node, json_stack.top()));
                               break;
...
bool xtypes_to_json(
        const eprosima::xtypes::DynamicData& xtypes_message,
        Json& json_message)
{
    std::stack<Json::pointer> json_stack;
    json_stack.push(&json_message);

    return xtypes_message.for_each([&](const eprosima::xtypes::DynamicData::ReadableNode& xtypes_node)
                   {
                       if (!xtypes_node.has_parent())
                       {
...
//==============================================================================
eprosima::xtypes::DynamicData convert(
        const eprosima::xtypes::DynamicType& type,
        const Json& json_message)
{
    eprosima::xtypes::DynamicData xtypes_message(type);
